...
ngram_3 <- tokens(corp_sample, what='word', remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_url = TRUE, ngrams = 3)
ngram_4 <- tokens(corp_sample, what='word', remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_url = TRUE, ngrams = 4)
ngram_5 <- tokens(corp_sample, what='word', remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_url = TRUE, ngrams = 5)
ngram_6 <- tokens(corp_sample, what='word', remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_url = TRUE, ngrams = 6)


co_loc_ng2 <- textstat_collocations(corp_sample, method = "lambda", size = 2, min_count = 5, 
                                    remove_numbers = TRUE, remove_punctuation = TRUE, remove_symbols = TRUE)
...
sorted_options <- options[,order("lambda")]

plot(sorted_options$lambda)
